<template>
  <div class="container">
    ...
    <div class="content">
      ...
      <ol style="margin: 10px 15px 30px 15px; font-weight: 500;">
        <li>새로운 기술을 찾아보고 공부하여 성장하는</li>
        <li>좋은 가독성과 확장성 있는 코드를 고민하는</li>
        <li>중복을 거부하는</li>
        <li>남의 코드를 쉽게 파악하고 나만의 방식으로 바꾸는</li>
        <li>정리와 글쓰기를 좋아하는</li>
      </ol>
      <table>
        <tbody>
      ...
      <div class="mgb-60">
        <div class="mgb-20">
          ...
          <table>
            <tbody>
              <tr>
                <td style="width: 144px; padding: 0;" class="td-center">
